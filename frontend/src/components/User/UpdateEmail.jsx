      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-sm">
        ...
        <form onSubmit={formik.handleSubmit} className="mt-4">
          ...
          <input
            ...
            className="w-full px-3 py-2 mt-2 border border-gray-600 bg-gray-700 text-white rounded-md focus:outline-none focus:ring focus:border-blue-500"
          />
          ...
          <button
            type="submit"
            className="w-full px-3 py-2 mt-4 text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring"
          >
            Add Email
          </button>
        </form>
