      ...
      {userPosts?.length < 0 ? (
        ...
        <section className="py-8">
          <div className="container px-4 mx-auto">
            <div className="pt-4 bg-gray-800 shadow rounded">
              ...
              <div className="p-4 overflow-x-auto">
                <table className="table-auto w-full text-white">
                  ...
                  <tbody>
                    {userPosts?.map((post) => {
                      return (
                        <tr className="text-xs bg-gray-700 hover:bg-gray-600">
                          ...
                          <td>
                            <span className="inline-block py-1 px-2 text-white bg-green-600 rounded-full">
                          ...
                          <td className="flex items-center mb-10 space-x-2">
                            <Link to={`/dashboard/update-post/${post._id}`}>
                              <FiEdit className="text-green-400 cursor-pointer" />
                            </Link>
