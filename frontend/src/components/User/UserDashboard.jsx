        ...
        <Transition.Root show={sidebarOpen} as={Fragment}>
          ...
          >
            ...
            <div className="fixed inset-0 flex">
              ...
              >
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1 bg-gray-800">
                  <Transition.Child
                    as={Fragment}
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-800 px-6 pb-4">
                    <div className="flex h-16 shrink-0 items-center">
                      {/* Logo */}
                      <Link to="/">
                        <h1 className="h-8 w-auto text-orange-500 text-4xl font-bold">
                          Investo
                        </h1>
                      </Link>
                    </div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-700 bg-gray-800 px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center">
              {/* Logo */}
              <Link to="/">
                <h1 className="h-8 w-auto text-orange-500 font-bold text-4xl">
                  Investo
                </h1>
              </Link>
            </div>
              ...
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li className="mt-auto">
                  <Link
                    ...
                    className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-400 hover:bg-gray-700 hover:text-orange-500"
                  >
                    <Cog6ToothIcon
